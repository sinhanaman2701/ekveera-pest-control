    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-gray-800">Ekveera Pest Control</span>
            </div>
      ...
      <section className="bg-gradient-to-br from-blue-600 to-blue-800 text-white py-20">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Best Pest Control in Badlapur, Thane</h1>
          <p className="text-xl md:text-2xl mb-8 opacity-90">Professional Pest Control services in Badlapur, Thane. Trusted by hundreds of customers.</p>
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            ...
            <a href="tel:09972306678" className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white/10 flex items-center justify-center gap-2">
              <Phone size={20} /> 09972306678
            </a>
          </div>
        </div>
      </section>
      ...
      <section id="about" className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="text-gray-600 text-lg text-center max-w-3xl mx-auto">Welcome to Ekveera Pest Control, your trusted Pest Control provider in Badlapur, Thane. We take pride in delivering exceptional service quality.</p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="max-w-xl mx-auto">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-gray-600">09972306678</span>
            </div>
            <div className="flex items-center gap-3 mb-4">
              <MapPin className="text-blue-600" size={20} />
              <span className="text-gray-600">Badlapur, Thane</span>
            </div>
      ...
      <footer className="bg-gray-800 text-white py-8 text-center">
        <p>© 2026 Ekveera Pest Control. All rights reserved.</p>
      </footer>
    </div>
  );
};
